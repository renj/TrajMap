...
def main(data_file, side, k, percent, width, alpha, _log, _run):
	...
	python graphdb_matcher_run.py -d skeleton_maps/skeleton_map_1m.db -t $path -o trips/matched_trips_1m/
	...
	python graphdb_matcher_run.py -d skeleton_maps/skeleton_map_1m_mm1_tr.db -t $path -o trips/matched_trips_1m_mm1_tr/
	...
	rm -r kde.png skeleton.png skeleton_maps/* trips/*
