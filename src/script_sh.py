...
for width in [10, 11, 12]:
    for cands_num in [1500, 1700, 2000, 2200, 2500]:
        os.system('python sacred_trajmap.py with ex_name=%s data=%s side=%d k=%d ratio=1.0 width=%d alpha=0.9 max_value=%f topic_model=None sel_cand_method=%s cands_num=%d' % (ex_name, data, side, 0, width, max_value, 'num_sum', cands_num))
